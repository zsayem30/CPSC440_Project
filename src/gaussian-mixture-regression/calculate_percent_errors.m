function [mean_percentage_error, std_percentage_error] = calculate_percent_errors(all_data, validation_output, errors)
...
%         [C,ia] = unique(all_data(:, 2:end), "rows", "stable");
%         all_data = all_data(ia, :);
        ...
        displacement_Vector = validation_output(:, 2:4) - previous_values;
